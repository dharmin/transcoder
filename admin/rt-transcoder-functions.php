 ...
 */
function wp_download_attachment( $image_url, $post_id = 0, $description = '', $post_data = array() ) {
	...
	if ( ! in_array( strtolower( $image_path_info['extension'] ), array( 'jpg', 'jpe', 'jpeg', 'gif', 'png' ), true ) ) {
